...
export const EXERCISE_LIBRARY: readonly LibraryExercise[] = [
  ...
  },
  {
    ...
    increment: { step: 2 },
    pairedDb: true,
    notes: "Second horizontal row, added 2026-08-20 with the Upper/Lower split. Chest supported on an incline bench, so the lower back and erectors contribute nothing — deliberate, because Lower B already carries the deadlift and this sits on Upper B two days later. Swap for T-Bar Row or Single-Arm Row (Dumbbell) if the bench is occupied.",
  },
  {
    id: "seated_cable_row",
  ...
  // ── PULL — Rear delts ──────────────────────────────────────────────────────
  {
    ...
    role: "accessory",
    increment: { step: 2.5 },
    aliases: ["face pull", "Face Pull"],
    notes: "Alias covers the lowercase name present in workout history — without it resolveExercise returned null and loadability silently defaulted.",
  },
  {
    id: "rear_delt_fly",
  ...
  // ── ACCESSORY — Calves / Hip abduction ─────────────────────────────────────
  {
    ...
    role: "accessory",
    increment: { step: 5 },
    aliases: ["Seated Calf Raise (Machine)", "Seated Calf Raise (Plate Loaded)"],
    notes: "Athlete's current Legs day calf work. Aliases cover the names actually present in workout history — without them resolveExercise returned null and loadability silently defaulted.",
  },
  {
    id: "standing_calf",
