...
export const EXERCISE_MUSCLES: Record<string, MuscleMapping> = {
  ...
  "chest fly":              { primary: [M.Chest], secondary: [M.FrontDelts] },
  "pec deck":               { primary: [M.Chest], secondary: [M.FrontDelts] },
  "dip":                    { primary: [M.Chest, M.Triceps], secondary: [M.FrontDelts] },
  "chest dip":              { primary: [M.Chest, M.Triceps], secondary: [M.FrontDelts] },
  "bench dip":              { primary: [M.Triceps], secondary: [M.Chest, M.FrontDelts] },
  "pullover":               { primary: [M.Lats, M.Chest], secondary: [M.Triceps, M.Serratus] },
  ...
  "shoulder press":         { primary: [M.FrontDelts], secondary: [M.Triceps, M.Traps] },
  ...
  "front raise":            { primary: [M.FrontDelts], secondary: [] },
  "rear delt fly":          { primary: [M.RearDelts], secondary: [M.Traps] },
  "rear delt raise":        { primary: [M.RearDelts], secondary: [M.Traps] },
  "reverse fly":            { primary: [M.RearDelts], secondary: [M.Traps] },
  "cable external rotation": { primary: [M.RearDelts], secondary: [] },
  "cable internal rotation": { primary: [M.FrontDelts], secondary: [] },
  ...
  "bicep curl":             { primary: [M.Biceps], secondary: [M.Brachialis] },
  ...
  "seated leg press":       { primary: [M.Quads], secondary: [M.Glutes, M.Hams] },
  "leg press single leg":   { primary: [M.Quads], secondary: [M.Glutes, M.Hams] },
  ...
  "lying leg curl":         { primary: [M.Hams], secondary: [] },
  "seated leg curl":        { primary: [M.Hams], secondary: [] },
  "calf raise":             { primary: [M.Calves], secondary: [M.Soleus] },
  "standing calf raise":    { primary: [M.Calves], secondary: [M.Soleus] },
