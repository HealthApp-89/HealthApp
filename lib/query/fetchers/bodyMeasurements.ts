...
const bodyMeasurements = createFetcher(
  async (supabase: SupabaseClient, userId: string): Promise<BodyMeasurement[]> => {
...
export const fetchBodyMeasurementsServer = bodyMeasurements.server;
/** Browser variant — self-constructs the cookie-bound browser client. */
export const fetchBodyMeasurementsBrowser = bodyMeasurements.browser;
