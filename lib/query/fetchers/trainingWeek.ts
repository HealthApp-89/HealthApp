...
const COLS =
  "id, user_id, block_id, week_start, session_plan, exercise_overrides, session_prescriptions, repatch_log, planned_activities, weekly_focus, intensity_modifier, rir_target, research_phase, proposed_by, chat_message_id, manual_session_edits, committed_at, created_at, updated_at";
