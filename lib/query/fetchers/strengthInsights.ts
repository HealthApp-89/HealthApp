...
export async function fetchStrengthInsightsServer(
  supabase: SupabaseClient,
  userId: string,
): Promise<StrengthInsight> {
...
export async function fetchStrengthInsightsBrowser(userId: string): Promise<StrengthInsight> {
