...
const ingestToken = createFetcher(
  async (supabase: SupabaseClient, userId: string): Promise<IngestTokenRow> => {
...
export const fetchIngestTokenServer = ingestToken.server;
export const fetchIngestTokenBrowser = ingestToken.browser;
