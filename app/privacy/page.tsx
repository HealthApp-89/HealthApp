  ...
  return (
    <main style={{ minHeight: "100dvh", padding: "24px 16px", background: COLOR.bg }}>
      <div style={{ maxWidth: "720px", margin: "0 auto" }}>
        <h1 style={{ fontSize: "22px", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: "8px", color: COLOR.textStrong }}>Privacy Policy</h1>
        <p style={{ color: COLOR.textMuted, fontSize: "12px", marginBottom: "32px" }}>Last updated: 2026-04-30</p>

        <section style={{ marginBottom: "24px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px", color: COLOR.textStrong }}>Who this app is for</h2>
          <p style={{ color: COLOR.textMid, lineHeight: "1.6", fontSize: "14px" }}>
        ...
        <section style={{ marginBottom: "24px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px", color: COLOR.textStrong }}>What data is collected</h2>
          <p style={{ color: COLOR.textMid, lineHeight: "1.6", fontSize: "14px" }}>
        ...
        <section style={{ marginBottom: "24px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px", color: COLOR.textStrong }}>Where data is stored</h2>
          <p style={{ color: COLOR.textMid, lineHeight: "1.6", fontSize: "14px" }}>
        ...
        <section style={{ marginBottom: "24px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px", color: COLOR.textStrong }}>Retention and deletion</h2>
          <p style={{ color: COLOR.textMid, lineHeight: "1.6", fontSize: "14px" }}>
        ...
        <section style={{ marginBottom: "24px" }}>
          <h2 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px", color: COLOR.textStrong }}>Contact</h2>
          <p style={{ color: COLOR.textMid, lineHeight: "1.6", fontSize: "14px" }}>
