...
export function LibraryRow({
  ...
  return (
    <div className="flex items-center gap-2 border-b border-divider p-3 last:border-b-0">
      <button
        type="button"
        onClick={onTap}
      ...
      >
        <div className="flex items-baseline justify-between">
          ...
          {sourceChip && (
            <span className="ml-2 rounded px-1.5 py-0.5 text-[10px] uppercase tracking-wider text-mid border border-divider">
              {sourceChip}
            </span>
          )}
        </div>
